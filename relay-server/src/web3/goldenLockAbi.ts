...
export const GOLDEN_LOCK_ABI = [
  ...
  "function submitAvailabilityProofFor(address hospital, uint256 resourceCode, uint256 isAvailable, uint256[2] a, uint256[2][2] b, uint256[2] c, uint256 nonce, bytes signature) external",
  ...
  "function availabilityNonces(address hospital) view returns (uint256)",
